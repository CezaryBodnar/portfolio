    ...
    return (
        <div className="hero-container">
            ...
            <div className="hero-title">
                ...
                <motion.h2 initial={{ opacity: 0, y: 150 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1.2, type: "tween" }} className="under-title">{language === 'en' ? `Hello, I'm a UI/UX Designer focused on creating simple and functional interfaces.` : 'Cześć, jestem projektantem UI/UX, skupionym na tworzeniu prostych oraz funkcjonalnych interfejsów.'}</motion.h2>
            </div>
            {/* <hr></hr> */}
        </div>
    )
